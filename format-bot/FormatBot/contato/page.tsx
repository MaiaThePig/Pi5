            ...
            <div className="bg-zinc-800 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400">Av. Tecnologia, 1000</p>
                    <p className="text-gray-400">São Paulo - SP, 01234-567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-400">(11) 8888-8888</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-zinc-700 p-2 rounded-full hover:bg-primary transition-colors">
